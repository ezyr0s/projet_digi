...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link active" href="soumettre.php">Soumettre un salon</a>
    ...
    if(!isset($_SESSION['utilisateur'])) {?>
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Vous devez vous connecter pour soumettre un salon</h5>
                        <a href="./compte.php" class="btn btn-primary">Se connecter</a>
                    </div>
                </div>
    <?php } ?>
    <?php
...
<?php
include "./php/formulaireSoumission.php";
} ?>
</body>
